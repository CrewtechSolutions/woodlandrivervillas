    ...
    <section data-anim-wrap className="layout-pt-md">
      <div className="container">
        <div data-anim-child="slide-up delay-1" className="row justify-center text-center">
          <div className="col-auto">
            ...
            <div className="text-15 uppercase mb-30 sm:mb-15">WHAT OUR GUESTS TRULY VALUE</div>
      ...
      <div className="relative container">
        <div className="row justify-center pt-100 sm:pt-50">
          <div className="col-xl-8 col-lg-10 col-9">
            <div className="overflow-hidden js-testimonialsSlider-1">
              <div className="swiper-wrapper">
                {testimonialsData.map((item) => (
                  <div key={item.id} className="swiper-slide">
                    <div data-split="lines" data-anim-child="split-lines delay-2" className="text-center">
                      <div className="text-sec text-40 md:text-24">{item.quote}</div>
                      <div className="mt-50">
              ...
              <div className="navAbsolute">
                <button
                  className="size-80 flex-center rounded-full js-testimonialsSlider-1-prev"
                ...
                <button
                  className="size-80 flex-center rounded-full js-testimonialsSlider-1-next"
